...
export const transformCategoryScores = (categoryScores: any, percentageScore: number): CategoryScore[] => {
  console.log("Processing category scores for radar chart:", categoryScores);
